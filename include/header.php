...
<header class="header">
        ...
        <div class="container clearfix">
            <div class="collapse in" id="top-collapse" aria-expanded="true" role="tabpanel">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="tel:1900-45-20"><i class="fa fa-phone" aria-hidden="true"></i>06.70.63.23.73</a>
                    </li>
                    <li>
                ...
                <ul class="list-unstyled">
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i>9h - 19h , lun-ven</li>
                </ul>
    ...
    <div class="logo"><a href="index.php"><img src="images/logo.png" alt="logo LyWeb" class="img-responsive"></a></div>
    <div class="bottom">
        <div class="container clearfix">
            <div class="navigation clearfix">
                <nav class="main-nav">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="index.php#pricing-section">Offres</a></li>
                        <li><a href="shop.php">ProjectID</a></li>
