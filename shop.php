...
<html lang="en">
    ...
    <!-- Responsive Menu -->
		...
		<div class="section page-title inner text-center">
			<div class="inner">
				<h3><a href="other_files/index.php">Accueil</a><i class="fa fa-angle-right" aria-hidden="true"></i><a href="#0">ProjectID</a></h3>
				<h1>Bienvenue sur<span class="orange">ProjectID</span></h1>
				<p>ProjectID est un module de Lyweb, il vous permet<br>de personnaliser votre offre avant un quelconque devis</p>
			</div> <!-- end .inner -->
		</div> <!-- end .page-title -->
		...
		<div class="section text-center">
			<div class="inner">
				<div class="container">
					<h1 class="dark">Nos<span class="orange">produits</span></h1>
